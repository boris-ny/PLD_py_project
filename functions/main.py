...
while True:
    ...
    for question in quizQuestions:
        ...
        count = 0
        # if answer corresponds with required output, count increases by 1, otherwise it remains c0nstant
        ...
        def result():
            percent_count = count / (len(quizQuestions)) * 100
            print(f"You got a total of {count} out of 10")
        result()
